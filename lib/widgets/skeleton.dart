...
class Skeleton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Shimmer.fromColors(
      baseColor: Theme.of(context).primaryColor.withValues(alpha: 0.05),
...
class TrackSkeleton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          const Skeleton(height: 56, width: 56, borderRadius: 14),
          const SizedBox(width: 16),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: const [
                Skeleton(height: 16, width: double.infinity, borderRadius: 8),
                SizedBox(height: 8),
